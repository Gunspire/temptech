      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 rounded-3xl border border-slate-200 bg-slate-50 p-6 sm:p-8 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-[#2C3B57]/10 border border-[#2C3B57]/20 flex items-center justify-center">
                <Bell className="w-6 h-6 text-[#2C3B57]" />
              </div>
              <div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-2 rounded-full bg-[#2C3B57]/10 border border-[#2C3B57]/20 px-3 py-1 text-xs font-extrabold text-[#2C3B57]">
                    <Bell className="w-4 h-4" />
                    New notification
                  </span>
                  <span className="text-xs font-semibold text-slate-500">Temp-Tech Agency App • {lead.receivedAt}</span>
                </div>
