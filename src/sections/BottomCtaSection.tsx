  ...
  return (
    <section className="relative overflow-hidden py-16 lg:py-20">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[#2C3B57]/80" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#2C3B57]/70 via-[#2C3B57]/60 to-[#2C3B57]/40" />
      </div>

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-5 text-white">
            <p className="text-white/80 font-semibold tracking-wider text-sm uppercase mb-3">Get in touch</p>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 text-sm mt-1">0800 123 4567</p>
                    <p className="text-white/80 text-xs mt-1">24/7 emergency call-outs</p>
                  </div>
                </div>
              </a>

              <a
                href="https://wa.me/447700900000?text=Hi%20Temp-Tech%20Roofing%20%E2%80%94%20I%27d%20like%20a%20free%20quote%20please."
                target="_blank"
                rel="noreferrer"
                className="group rounded-2xl bg-white/10 border border-white/15 backdrop-blur px-5 py-4 hover:bg-white/15 transition"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 text-sm mt-1">Quick photos & a rough estimate</p>
                    <p className="text-white/80 text-xs mt-1">Typical reply within 1–2 hours</p>
                  </div>
                </div>
              </a>

              <a
                href="mailto:temptech@gmail.com"
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 text-sm mt-1">temptech@gmail.com</p>
                ...
                {footerFormStatus === "success" ? (
                  ...
                  <>
                    <div className="flex items-start justify-between gap-4 mb-6">
                      ...
                      <div className="hidden sm:flex items-center gap-2 rounded-full bg-[#2C3B57]/10 border border-[#2C3B57]/20 px-3 py-1.5 text-xs font-semibold text-[#2C3B57]">
                    ...
                    <form onSubmit={handleFooterQuoteSubmit} className="space-y-4">
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <input
                            type="text"
                            required
                            className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#2C3B57] focus:ring-2 focus:ring-[#2C3B57]/20 outline-none transition-all bg-white"
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <select className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#2C3B57] focus:ring-2 focus:ring-[#2C3B57]/20 outline-none transition-all bg-white">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <textarea
                          rows={4}
                          className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#2C3B57] focus:ring-2 focus:ring-[#2C3B57]/20 outline-none transition-all bg-white resize-none"
