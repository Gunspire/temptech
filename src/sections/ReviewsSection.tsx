    ...
    <section id="reviews" className="py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-1">
                    ...
                    {" "}from homeowners across Colchester & surrounding areas.
                  </p>
                </div>
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              text: "Temp-Tech Roofing were fantastic from start to finish. Gave a clear quote, turned up on time, and the new roof looks amazing. Left the garden spotless too.",
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 bg-[#2C3B57]/10 rounded-full flex items-center justify-center text-[#2C3B57] font-bold">
                    {review.author[0]}
                  </div>
                  <div>
