      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-8">
            <div className="inline-flex items-center gap-2 bg-[#2C3B57]/20 border border-[#2C3B57]/30 rounded-full px-4 py-1.5 mb-6 backdrop-blur-sm">
              <BadgeCheck className="w-4 h-4 text-[#2C3B57]" />
              <span className="text-white/90 text-sm font-medium">Top Rated UK Roofing Company</span>
            </div>

            <h1 className="text-3xl lg:text-5xl font-bold text-white leading-tight mb-6">
              Premium roofing in <span className="text-[#2C3B57]">Colchester</span>. Fast quotes, tidy installs,
              guaranteed work.
            </h1>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-slate-700/50">
              <div className="flex flex-col max-w-[200px]">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 bg-[#2C3B57] rounded-full flex items-center justify-center text-xs font-bold text-white">
                    J
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        type="text"
                        required
                        className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#2C3B57] focus:ring-2 focus:ring-[#2C3B57]/20 outline-none transition-all"
