      ...
      <div className="relative">
        {chatOpen && (
          <div className="w-[340px] max-w-[calc(100vw-2.5rem)] rounded-3xl overflow-hidden border border-slate-200 shadow-2xl bg-white">
            <div className="bg-gradient-to-r from-[#2C3B57] via-[#2C3B57] to-[#2C3B57] px-5 py-4 text-white">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-sm font-semibold text-white/90">Temp-Tech Roofing Live Help</p>
                  <p className="text-lg font-bold leading-tight">How can we help?</p>
                  <p className="text-xs text-white/80 mt-1">Typical reply within 1 hour (Mon–Fri)</p>
                </div>
                <button
                  type="button"
                  ...
                  <form onSubmit={handleChatSubmit} className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        ...
                        <input
                          required
                          type="text"
                          className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-[#2C3B57] focus:ring-2 focus:ring-[#2C3B57]/20 outline-none transition text-sm"
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        required
                        rows={3}
                        className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-[#2C3B57] focus:ring-2 focus:ring-[#2C3B57]/20 outline-none transition text-sm resize-none"
        ...
        {!chatOpen && (
          <button
            ...
            className="rounded-full shadow-2xl bg-[#2C3B57] hover:bg-[#1e2a3d] transition text-white px-4 py-3 flex items-center gap-2"
